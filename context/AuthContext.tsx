...
export const AuthContextProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <AuthContext.Provider value={{ user, userInfo, signUp, logIn, resetPassword, logInWithGoogle, logOut, storeFirstAndLastName, hasFirstAndLastName, validUser, getFirstName, getRegisteredEvents, setUserInformation }}>
